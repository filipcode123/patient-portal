CREATE DATABASE  IF NOT EXISTS `thegeneralpractitioner` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
BEGIN
	...
	DELETE from booking b where b.id_booking = id_booking;
...
BEGIN
    ...
    DELETE FROM certification AS c WHERE c.id_cert = id_cert;
...
BEGIN
    ...
    DELETE FROM doctor AS d WHERE d.id_doctor = id_doctor;
...
BEGIN
	...
	DELETE FROM notification n where n.id_notif = id_notif;
...
BEGIN
	...
	DELETE FROM patient AS p WHERE p.id_patient = id_patient;
...
BEGIN
	...
	select * from doctor as d, patient as p where p.id_patient=id_patient AND p.id_doctor = d.id_doctor;
...
BEGIN
    ...
    SELECT * FROM patient AS p WHERE p.email=email;
...
BEGIN
	...
	select * from booking b where b.id_booking = id_booking;
...
BEGIN
	...
	select * from booking b where b.id_doctor = id_doctor;
...
BEGIN
	...
	SELECT * FROM certification AS c WHERE c.id_cert = id_cert;
...
BEGIN
	...
	SELECT * FROM certification AS c WHERE c.id_doctor = id_doctor;
...
BEGIN
	...
	SELECT * FROM doctor AS d WHERE d.id_doctor = id_doctor;
...
BEGIN
	...
	SELECT * from notification n where n.id_notif = id_notif;
...
BEGIN
	...
	SELECT * FROM notification n WHERE n.id_patient=id_patient;
...
BEGIN
    ...
    SELECT * FROM patient AS p WHERE p.id_patient=id_patient;
...
BEGIN
	update booking b
    set
		b.id_patient = id_patient,
        b.id_doctor = id_doctor,
        b.booking_time = booking_time,
        b.type = booking_type,
        b.details = booking_details,
...
BEGIN
    ...
    SET
        ...
        d.gender = gender,
        d.telephone_number = telephone_number
	WHERE
